...
* Install Babel to locally transform JSX to pure JavaScript on build up. The command line "$ npx babel src --presets @babel/react --out-dir public" should be changed into "$ npx babel public\src --presets @babel/react --out-dir public" if you care in the project root directory. Update the script code block in the index.html.